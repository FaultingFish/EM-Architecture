...
6. **`ROADMAP.md`** (repo root) — living checklist of features tiered into V1 must-haves, V1+ nice-to-haves, Phase 2. Tick boxes in the same commit that ships the feature.
